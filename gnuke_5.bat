...
IF '%command%' == 'checkout_undo' GOTO BASE_UNDO
IF '%command%' == 'undo_all' GOTO BASE_UNDO_ALL
IF '%command%' == 'checkout_undo_all' GOTO BASE_UNDO_ALL
...
IF '%command%' == 'startAPI' GOTO API_RUN
IF '%command%' == 'sAPI' GOTO API_RUN
IF '%command%' == 'SAPI' GOTO API_RUN
IF '%command%' == 'API' GOTO API_RUN
IF '%command%' == 'api' GOTO API_RUN
